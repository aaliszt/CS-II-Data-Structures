...
int main () {
    ...
    }
    {
        //------------------------------------------------------
        // Setup fixture
        bigint left("2345899105963759374702649");
        bigint right("1930475968475928495739392");
        bigint result;
        ...
        // Verify
        assert(left ==   "2345899105963759374702649");
        assert(right ==  "1930475968475928495739392");
        assert(result == "4528701848532203184455887595940360782663396049408");
    }
